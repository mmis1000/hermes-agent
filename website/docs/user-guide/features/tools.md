...
| **Agent orchestration** | `todo`, `clarify`, `execute_code`, `delegate_task`, `delegation` | Planning, clarification, code execution, subagent delegation, and durable steer/resume/lifecycle control. |
