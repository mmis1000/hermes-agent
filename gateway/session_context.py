...
# Approval mode is also per-run. The built-in cron scheduler shares the
# gateway process, so a process-global HERMES_CRON_SESSION flag would classify
# every later live chat as unattended cron work.
